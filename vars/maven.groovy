    ...
    pipeline {
        ...
        stages {
            ...
            stage('Code Quality') {
                steps {
                    //  sh 'ls -l'
                    // sh 'sonar-scanner -Dsonar.projectKey=${component} -Dsonar.host.url=http://172.31.82.118:9000 -Dsonar.login=admin -Dsonar.password=admin123 -Dsonar.qualitygate.wait=true -Dsonar.java.binaries=./target'
            ...
            stage('Release Application') {
                ...
                steps {
                    ...
                    sh 'docker build -t 283181175075.dkr.ecr.us-east-1.amazonaws.com/${component}:${TAG_NAME} .'
                    sh 'docker push 283181175075.dkr.ecr.us-east-1.amazonaws.com/${component}:${TAG_NAME}'
                }
